 ...
 */
package io.mifos.smsalert.api.v1.client;
...
@FeignClient(value="smsalert-v1", path="/smsalert/v1", configuration = CustomFeignClientsConfiguration.class)
public interface SmsalertManager {
