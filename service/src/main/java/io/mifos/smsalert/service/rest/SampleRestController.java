 ...
 */
package io.mifos.smsalert.service.rest;

import io.mifos.anubis.annotation.AcceptedTokenType;
import io.mifos.anubis.annotation.Permittable;
import io.mifos.core.command.gateway.CommandGateway;
import io.mifos.core.lang.ServiceException;
import io.mifos.smsalert.api.v1.PermittableGroupIds;
import io.mifos.smsalert.api.v1.domain.Sample;
import io.mifos.smsalert.service.ServiceConstants;
import io.mifos.smsalert.service.internal.command.InitializeServiceCommand;
import io.mifos.smsalert.service.internal.command.SampleCommand;
import io.mifos.smsalert.service.internal.service.SampleService;
...
public class SampleRestController {
  ...
  @Permittable(value = AcceptedTokenType.TENANT, groupId = PermittableGroupIds.SMSALERT_MANAGEMENT)
  @RequestMapping(
          value = "/sample",
