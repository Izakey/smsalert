...
import io.mifos.smsalert.api.v1.domain.Sample;
import io.mifos.smsalert.service.SmsalertConfiguration;
...
public class TestSample extends SuiteTestEnvironment {
  ...
  @EnableFeignClients(basePackages = {"io.mifos.smsalert.api.v1.client"})
  @RibbonClient(name = APP_NAME)
  @Import({SmsalertConfiguration.class})
  @ComponentScan("io.mifos.smsalert.listener")
  ...
  @Autowired
  private SmsalertManager testSubject;
  ...
  public boolean waitForInitialize() {
    try {
      return this.eventRecorder.wait(SmsalertEventConstants.INITIALIZE, APP_VERSION);
  ...
  public void shouldCreateSample() throws InterruptedException {
    ...
    Assert.assertTrue(this.eventRecorder.wait(SmsalertEventConstants.POST_SMSALERT, sample.getIdentifier()));
