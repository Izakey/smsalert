 ...
 */
package io.mifos.smsalert.listener;
...
public class CustomerEventListener {
  ...
  @JmsListener(
          ...
          selector = SmsalertEventConstants.SELECTOR_POST_SMSALERT
  )
  public void customerCreatedEvent(@Header(TenantHeaderFilter.TENANT_HEADER) final String tenant,
                                   final String payload) {
    this.eventRecorder.event(tenant, SmsalertEventConstants.POST_SMSALERT, payload, String.class);
  }
